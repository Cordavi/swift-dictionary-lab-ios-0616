 ...
 */
var stateAndCapitals = ["New York":"Albany",
                        "Ohio":"Columbus",
                        "Florida":"Tallahassee",
                        "Georgia":"Atlanta",
                        "Kentucky":"Frankfort"
 ...
 */
var capital = stateAndCapitals["Florida"]
 ...
 */
var anotherCapital = stateAndCapitals["Pennsylvania"]
 ...
 */
stateAndCapitals["Pennsylvania"] = "Harrisburg"
...
stateAndCapitals.removeValueForKey("Pennsylvania")
print(stateAndCapitals)
 ...
 */
let state = "New York"
if let newYorkCapital = stateAndCapitals[state] {
 ...
 */
let bandDict = ["Nirvana": ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
                "The Beatles": ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
                "The Breeders": ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
                "Pixies": ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
 ...
 */
let bandName = "Pixies"
if let pixiesMembers = bandDict[bandName] {
    print("\(pixiesMembers)")
}
